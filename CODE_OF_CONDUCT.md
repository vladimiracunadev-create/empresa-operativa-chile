...
aquí sea una experiencia libre de acoso para todo el mundo, sin importar edad, experiencia,
...
- Aceptar críticas técnicas sobre el código sin tomarlas como personales, y darlas sin hacerlas
  personales.
- Explicar el contexto chileno o contable cuando alguien no lo tenga: no todo el mundo sabe qué
...
- Publicar información privada de terceros sin permiso explícito. **En este proyecto esto
  incluye contabilidad, RUT, folios y datos tributarios de personas o empresas reales**, aunque
...
o del perfil de [@vladimiracunadev-create](https://github.com/vladimiracunadev-create).

Todas las quejas se revisarán y se responderán. Se respetará la privacidad de quien reporte.
